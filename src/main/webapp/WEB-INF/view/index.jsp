                        ...
                        <c:forEach items="${menuList }" var="menu" varStatus="status">
                         	<li class="">
                         		<shiro:hasPermission name="${menu.code } ">
                        			<a href="javascript:;">
	                                <i class="${menu.icon }"></i><span class="title"> ${menu.name }</span><span
	                                class="arrow "> </span>
	                                </a>
                        		</shiro:hasPermission>
                         		<ul class="sub-menu">
                         			<c:forEach items="${menu.childMenus }" var="childMenu" varStatus="status">
                         				<shiro:hasPermission name="${childMenu.code }">
		                                    <li>
			                                    <a href='<c:url value="${childMenu.url }"></c:url>'>
			                                        ${childMenu.name }
			                                    </a>
			                                </li>
		                                </shiro:hasPermission>
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h3 class="page-title" id="index-page-title">Dashboard1</h3>
